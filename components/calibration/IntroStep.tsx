    ...
    <div className="flex flex-col items-center justify-center min-h-screen px-6 py-12 space-y-8">
      ...
      <div className="w-full max-w-sm space-y-3">
        <GlassCard className="p-4 flex items-start gap-4">
          ...
          <div>
            <p className="text-white font-medium text-sm">Sweep left and right</p>
            <p className="text-white/50 text-sm mt-0.5">Pan your phone across your view to map the horizontal span</p>
          </div>
        </GlassCard>
        ...
        <GlassCard className="p-4 flex items-start gap-4">
          ...
          <div>
            <p className="text-white font-medium text-sm">Tilt up and down</p>
            <p className="text-white/50 text-sm mt-0.5">Tilt your phone from the horizon to the top of your window</p>
          </div>
        </GlassCard>
      </div>
